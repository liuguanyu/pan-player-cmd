...
type PlaylistItem struct {
	...
	LRCPath        string `json:"lrc_path,omitempty"`         // 歌词文件路径
}
...
type LyricSearchResult struct {
	...
	Source   string `json:"source"`   // 来源provider名称
}
...
type PlaybackState struct {
	...
	// 歌词搜索UI状态
	LyricSearchVisible  bool                `json:"lyric_search_visible"`  // 歌词搜索UI是否可见
	LyricSearchResults  []LyricSearchResult `json:"lyric_search_results"`  // 搜索结果列表
	LyricSearchSelected int                 `json:"lyric_search_selected"` // 当前选中的索引
